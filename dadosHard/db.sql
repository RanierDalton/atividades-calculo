...
CREATE TABLE plcEmpresa(
    idEmpresa INT,
    idPlc INT,
    PRIMARY KEY (idEmpresa, idPlc),
    FOREIGN KEY (idEmpresa) REFERENCES empresas(idEmpresa),
    FOREIGN KEY (idPlc) REFERENCES plc(idPlc)
);
...
INSERT INTO plc(modeloPlc, ano) VALUES
('SIMATIC S7-1200', 2022),
('SIMATIC S7-1500', 2023),
('SIMATIC S7-1200', 2021),
('SIMATIC S7-300', 2020);

INSERT INTO empresa_plc(idEmpresa, idPlc) VALUES
(1, 1),
(1, 2),
(2, 3),
(2, 4);
